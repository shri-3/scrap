    ...
    <div class="page-content fade-in-up">
        <div class="row">
            ...
            <div class="col-md-10">
                <div class="ibox">
                    <div class="ibox-head">
                        <div class="ibox-title">Add New Division</div>
                    </div>
                    <div class="ibox-body">
                        <form action="store_d_users.php" method="post">
                            <div class="form-group">
                                <label>Name Depot</label>
                                <input name="rollid" class="form-control" value="3" type="hidden" placeholder="Name">
                            ...
                            <div class="form-group">
                                ...
                                <select name="division" class="form-control select2_demo_2">
