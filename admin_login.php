    ...
    <form id="login-form" action="login_action.php" method="post">
        ...
        <div class="form-group">
            <div class="input-group-icon right">
                ...
                <input class="form-control" type="hidden" value="1" name="a_id" placeholder="User Name" autocomplete="off">
        ...
        <div class="text-center">For Division & Depot member?
            <a class="color-blue" href="login.php">Login</a>
        </div>
    </form>
